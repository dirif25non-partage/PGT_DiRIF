...
On utilise ici le mot PGT dans le sens particulier qu'il a dans l'application SIRIUS et non dans le sens plus général de PGT que l'on trouve dans des documents sur la gestion du trafic.  

Qu'est-ce qu'un PGT ?
----------------------
Un PGT est un objet de l'application SIRIUS qui sert à activier un ensemble de signaux dynamiques: PMV, B1, B14, R1, R24, SAV ... Les PGT permettent donc d'afficher : 
