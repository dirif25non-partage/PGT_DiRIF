...
Pendant qu'un PGT est activé, il n'est pas possible de modifier les autres niveaux du même sous-ensemble.  

Les PGT sont organisés en arborescence à 3 étages : **Nom, Sous-ensemble & Niveau**.  
:doc:`Les principes de dénomination sont présentés ici .<SelectionStations>`

Créations de PGT au premier semestre 2023
------------------------------------------
...
Un PGT est attribué à un PCTT en fonction de la 3ème lettre de son nom (O,E,N,S, C pour le CCT).
